...
{
    public static async Task PrepDb(IApplicationBuilder app)
    {
    ...
    private static async Task SeedActivities(AppDbContext context, List<User> users)
    {
        if (!context.Activities.Any() && users.Any()) 
        {
